...
const totalSumInteger = Math.floor(chargerPrice) + Math.floor(phonePrice) + Math.floor(headphonePrice)
...
const netProfit = (((totalSum / 2) - (totalSum - (totalSum - price4Customer))).toFixed(2))
